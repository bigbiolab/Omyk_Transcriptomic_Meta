...
# 01. Load raw counts
PRJNA559610 <- read.xlsx("data/Raw Counts/PRJNA559610.xlsx")
glimpse(PRJNA559610)

# 02.Load metadata
metadata <- read.csv("data/Raw Counts/metadata/PRJNA559610.csv")
glimpse(metadata)

# 03.Create a matrix &  add gene ids as row names
count_data <- PRJNA559610 |> 
...
write.csv(res, "outputs/DESeq2/PRJNA559610.csv", 
          row.names = FALSE)
# ------------------------------------------------------------------------------
# 17. Get Normalized counts
...
write.csv(normalized_counts, "outputs/DESeq2/Normalized Counts/PRJNA559610_normalized_counts.csv",
          row.names = FALSE)
# ------------------------------------------------------------------------------
...
# Export the plot
ggsave(filename = "figures/PCA/PRJNA559610.png",
       plot = pca_plot,
       width = 5,
       height = 5,
       units = "in",
