...
# 01. Load raw counts
PRJNA704549 <- read.xlsx("data/Raw Counts/PRJNA1000995.xlsx")
glimpse(PRJNA704549)

# 02.Load metadata
metadata <- read.csv("data/Raw Counts/metadata/PRJNA1000995.csv")
glimpse(metadata)
...
write.csv(res, "outputs/DESeq2/PRJNA1000995.csv", 
          row.names = FALSE)
...
write.csv(normalized_counts, "outputs/DESeq2/Normalized Counts/PRJNA1000995_normalized_counts.csv",
          row.names = FALSE)
# ------------------------------------------------------------------------------
...
# Export the plot
ggsave(filename = "figures/PCA/PRJNA1000995.png",
       plot = pca_plot,
       width = 5,
       height = 5,
       units = "in",
