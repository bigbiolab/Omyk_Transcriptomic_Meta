# Common differentially expressed genes across heat stress studies
...
# Create Venn diagram
png("figures/Venn Diagram/Venn_diagram_heat_stress.png",
    units = "in", width = 6, 
    height = 6, res = 2000)
...
venn.plot <- venn.diagram(
  x = gene_sets,
  filename = NULL,
  fill = c("#99d8c9", "#fec44f"),
  alpha = 0.6,
  cex = 0.8,
  cat.cex = 1,
  cat.col = c("#31a354","#e6550d"),
  cat.pos = c(0, 0),
...
write.csv(intersect_genes, "outputs/Venn Diagram/intersect_heat_genes.csv", row.names = FALSE)
